...
export interface YourContractInterface extends utils.Interface {
  ...
  getFunction(nameOrSignatureOrTopic: 'purpose' | 'setPurpose'): FunctionFragment;

  encodeFunctionData(functionFragment: 'purpose', values?: undefined): string;
  encodeFunctionData(functionFragment: 'setPurpose', values: [PromiseOrValue<string>]): string;
...
export type SetPurposeEvent = TypedEvent<[string, string], SetPurposeEventObject>;
...
export interface YourContract extends BaseContract {
  ...
  callStatic: {
    ...
    setPurpose(newPurpose: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
  };

  filters: {
    'SetPurpose(address,string)'(sender?: null, purpose?: null): SetPurposeEventFilter;
