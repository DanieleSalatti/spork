...
export class IERC20MintableBurnable__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IERC20MintableBurnable {
    return new Contract(address, _abi, signerOrProvider) as IERC20MintableBurnable;
  }
}
